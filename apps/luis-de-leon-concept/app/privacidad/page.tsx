...
export const metadata = { title: "Política de Privacidad — Luis De León Concept" }
      ...
      <main className="bg-background py-20">
        <div className="max-w-3xl mx-auto px-4">
          ...
          <div className="prose prose-sm max-w-none text-foreground-light space-y-4">
            <p>En Luis De León Concept nos tomamos muy en serio la privacidad de nuestros usuarios. Esta política describe cómo recopilamos, usamos y protegemos tu información personal.</p>
