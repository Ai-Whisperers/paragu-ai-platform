...
export const metadata = { title: "Second Opinion" }

export default async function SecondOpinion({ params }: { params: Promise<{ locale: string }> }) {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
      <h1 className="text-4xl sm:text-6xl font-bold mb-3">{c.title || "Second Opinion"}</h1>
