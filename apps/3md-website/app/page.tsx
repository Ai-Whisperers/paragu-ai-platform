...
const services = [
  {
    ...
    desc: "Estrategia de redes sociales, campañas pagas y content creation para hacer crecer tu marca.",
  },
  {
    icon: Film,
    title: "Producción Audiovisual",
    desc: "Cine publicitario, videos corporativos y cobertura de eventos con calidad profesional.",
  },
  {
    icon: Camera,
    title: "Fotografía",
    desc: "Fotografía de productos, eventos, corporativa y lifestyle con edición profesional.",
  },
  {
    icon: Megaphone,
    title: "Publicidad",
    desc: "Campañas 360°, branding corporativo y estrategia creativa para marcas que quieren destacar.",
  },
]
    ...
    <>
      ...
      <section className="py-24 bg-background">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <h2 className="font-heading text-3xl md:text-4xl font-bold text-foreground mb-4">Qué hacemos</h2>
      ...
      <section className="py-16 bg-surface border-y border-border">
        <div className="max-w-7xl mx-auto px-4 text-center">
          <p className="text-foreground-muted text-sm tracking-widest uppercase mb-8">Marcas que confían en nosotros</p>
