      ...
      <div className="container-page">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
          {previewCategories.map((cat, i) => {
            ...
            return (
              <ScrollReveal key={cat.name} delay={i * 100} direction="up">
                <Link
                  href={`/${lang}/servicios`}
                ...
                >
                  ...
                  <h3 className="font-heading text-xl font-bold text-primary mb-2">{cat.name}</h3>
                  ...
                  <p className="text-sm text-foreground-light mb-4 line-clamp-2">
                    {cat.items.slice(0, 3).map(s => s.name).join(" · ")}
                  </p>
