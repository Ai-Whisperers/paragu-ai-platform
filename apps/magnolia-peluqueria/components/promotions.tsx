...
import { promotions, loyalty, giftCards, waLink } from "@/lib/config"
...
export function Promotions({ lang }: PromotionsProps) {
  const l = {
    es: { header: "Promociones", sub: "Ofertas exclusivas para vos", cta: "Aprovechar oferta", gift: "Tarjetas de Regalo", giftSub: "Regalá bienestar" },
    en: { header: "Promotions", sub: "Exclusive offers for you", cta: "Claim this offer", gift: "Gift Cards", giftSub: "Give the gift of self-care" },
  }[lang] ?? { header: "Promociones", sub: "Ofertas exclusivas para vos", cta: "Aprovechar oferta", gift: "Tarjetas de Regalo", giftSub: "Regalá bienestar" }
              ...
              <div className="p-6">
                ...
                {promo.expires && (
                  <p className="text-xs text-foreground-muted mb-4">
                    {lang === "en" ? "Expires:" : "Vence:"} {promo.expires}
                  </p>
                )}
...
export function LoyaltySection({ lang }: LoyaltySectionProps) {
  ...
  if (!loyalty?.steps?.length) return null
    ...
    <section className="py-20 bg-primary text-white relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-4 relative z-10">
        ...
        <div className="text-center mt-14">
          <a href={waLink(lang === "en" ? "Hi! I want to join the rewards program" : "Hola! Quiero enterarme más sobre el Programa Magnolia Rewards")}
            target="_blank" rel="noopener noreferrer"
...
export function GiftCardsSection({ lang }: GiftCardsSectionProps) {
  const l = {
    es: { header: "Tarjetas de Regalo", sub: "Regala un Momento Magnolia", cta: "Comprar" },
    en: { header: "Gift Cards", sub: "Give the gift of self-care", cta: "Buy" },
  }[lang] ?? { header: "Tarjetas de Regalo", sub: "Regala un Momento Magnolia", cta: "Comprar" }
      ...
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {giftCards.map((card, i) => {
            ...
            const Icon = GIFT_ICONS[card.icon] ?? Star
            return (
