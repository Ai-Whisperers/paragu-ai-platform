...
const labels: Record<string, { title: string; subtitle: string; namePlaceholder: string; emailPlaceholder: string; button: string; success: string; error: string }> = {
  es: {
    ...
    subtitle: "Suscribite a nuestro newsletter y recibí consejos de cuidado capilar, tendencias y ofertas exclusivas.",
  ...
  en: {
    title: "Get Tips & News",
    subtitle: "Subscribe to our newsletter and receive hair care tips, trends, and exclusive offers.",
