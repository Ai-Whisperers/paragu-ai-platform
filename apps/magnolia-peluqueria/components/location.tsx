        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <p className="text-foreground-light text-lg mb-8 leading-relaxed">
              Estamos ubicadas en una zona centrica de Asunción, fácilmente accesibles desde cualquier punto de la ciudad. Consultanos por mensaje y te enviamos la ubicación exacta.
            </p>
