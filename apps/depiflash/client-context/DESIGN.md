...
version: alpha
name: Depiflash
description: Auto-generated DESIGN.md for depiflash. Refine colors, typography, components sections as design matures.
colors:
  accent: "#E8A0BF"
...
`depiflash` — auto-generated design spec from `apps/depiflash/globals.css`.
...
- ✅ **AAA** 15.35:1 — `fg` (#1A1A2E) on `surface` (#F8F0FF) — body on white card
- ❌ **FAIL** 1.06:1 — `fg-muted` (#F3E8FF) on `surface` (#F8F0FF) — secondary text on white
- ❌ **FAIL** 2.06:1 — `accent` (#E8A0BF) on `bg` (#FFFFFF) — link text
