...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    siteName: c.siteName,
    images: [{ url: 'https://bufete-mendez.paragu-ai.com/og/og-image.png', width: 1200, height: 630 }],
    locale: 'es_PY',
    type: 'website',
  },
  twitter: {
    ...
    title: home.seo.title,
    description: home.seo.description,
    images: ['https://bufete-mendez.paragu-ai.com/og/og-image.png'],
  },
  alternates: {
    canonical: 'https://bufete-mendez.paragu-ai.com',
    languages: {
      'es': 'https://bufete-mendez.paragu-ai.com/',
      'en': 'https://bufete-mendez.paragu-ai.com/en/',
    },
  },
}
