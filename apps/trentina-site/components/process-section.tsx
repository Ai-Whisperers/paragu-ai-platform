        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-5xl mx-auto">
          {steps.map((step, i) => (
            <div key={step.title} className="relative group">
              ...
              {/* Step circle with optional image */}
              <div className="relative flex flex-col items-center text-center">
                <div className="relative w-16 h-16 mb-5">
                  {step.image ? (
                    <div className="w-full h-full rounded-full overflow-hidden border-2 border-gold/30">
                    ...
                    <div className="w-full h-full rounded-full bg-gold/10 border border-gold/30 flex items-center justify-center">
