...
const valueImages: Record<string, string> = {
  Artesanal: "/images/values/artesanal.jpg",
  Pureza: "/images/values/pureza.jpg",
  Pasión: "/images/values/pasion.jpg",
};
        ...
        <div className="container-page">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
            {a.values.map((v: { title: string; description: string }) => {
              const imgSrc = valueImages[v.title];
              return (
                <div
                  key={v.title}
                  className="rounded-xl bg-[var(--color-background)] border border-[var(--color-border)] text-center hover:border-gold/40 transition-all group overflow-hidden"
                >
                  {imgSrc && (
