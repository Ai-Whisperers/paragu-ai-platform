              ...
              return (
                ...
                >
                  ...
                  <div className="aspect-[16/9] relative">
                    <Image
                      src={
                        pack.id === "pack-1-longneck" ? "/images/packs/pack-longneck.jpg" :
                        pack.id === "pack-2-pilsen" ? "/images/packs/pack-pilsen-500.jpg" :
                        pack.id === "pack-3-apa" ? "/images/packs/pack-apa.jpg" :
                        pack.id === "pack-4-ipa" ? "/images/packs/pack-ipa.jpg" :
                        "/images/packs/pack-metatron.jpg"
                      }
                      alt={pack.name}
                      fill
