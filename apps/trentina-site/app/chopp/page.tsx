...
// Service type → image mapping
  const serviceImages: Record<string, string> = {
    Fiestas: "/images/services/service-fiesta.jpg",
    "Eventos empresariales": "/images/services/service-corporativo.jpg",
    "Eventos particulares": "/images/services/service-particular.jpg",
    "Instalación en locales": "/images/services/service-local.jpg",
  };
      ...
      <section className="section-padding bg-[var(--color-background)]">
        <div className="container-page max-w-5xl">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {ch.beersOnTap.map((beer: any, idx: number) => {
              const beerImages = [
                "/images/beers/pilsen-glass.jpg",
                "/images/beers/apa.jpg",
                "/images/beers/ipa.jpg",
                "/images/beers/metatron.jpg",
              ];
              return (
                <div
                  key={beer.name}
                  className="p-6 rounded-xl bg-[var(--color-surface-alt)] border border-[var(--color-border)] text-center hover:border-gold/30 transition-all group overflow-hidden relative"
                >
                  {/* Beer image */}
                  <div className="absolute inset-0 z-0 opacity-10">
                    {/* eslint-disable-next-line @next/next/no-img-element */}
                    <img src={beerImages[idx] || beerImages[0]} alt={beer.name} className="w-full h-full object-cover" />
                  </div>
        ...
        <div className="container-page max-w-5xl">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 max-w-3xl mx-auto">
            {ch.services.map((service: any) => {
              const imgSrc = serviceImages[service.type];
              return (
                <div
                  key={service.type}
                  className="rounded-xl bg-[var(--color-background)] border border-[var(--color-border)] hover:border-gold/40 transition-all group overflow-hidden"
                >
                  {imgSrc && (
