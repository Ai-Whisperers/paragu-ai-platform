...
- bf59f3f fix(deploy): add Dockerfile.standalone for golden-visa-advisory and ozmontania-website
- 30b7ecc docs: rewrite standalone-repo GitHub URLs to point at monorepo apps/ paths
