    ...
    <>
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-20 text-center px-4 max-w-3xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row items-center justify-center gap-6 mb-8">
            ...
            >
              <svg
                className="w-6 h-6 text-blood-500 group-hover:text-gold-400 transition-colors"
                fill="none"
                viewBox="0 0 24 24"
                stroke="currentColor"
              >
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {content.howItWorks.steps.map((s, i) => (
              <div
                key={i}
                className="text-center p-8 border border-white/5 rounded-xl hover:border-gold-400/30 transition-all bg-white/[0.02] group reveal"
              >
                <div className="w-14 h-14 mx-auto mb-4 rounded-full bg-blood-500/10 border border-blood-500/20 flex items-center justify-center">
                  <span className="text-2xl">{s.icon}</span>
                </div>
                <div className="w-8 h-0.5 bg-gold-400 mx-auto mb-4 opacity-60" />
      ...
      <section className="py-24 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {content.experience.items.map((it, i) => (
              <div
                key={i}
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {content.testimonials.items.map((t, i) => (
              <div
                key={i}
                className="p-6 border border-white/5 rounded-xl bg-white/[0.02] text-left reveal"
              >
      ...
      <section className="py-24 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-6 max-w-2xl mx-auto">
            {content.eventDetails.items.map((d, i) => (
                ...
                <div>
                  ...
                  {d.link ? (
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="text-sm text-gray-400 hover:text-gold-400 transition-colors underline underline-offset-2"
                    >
                      {d.description}
                    </a>
                  ) : (
