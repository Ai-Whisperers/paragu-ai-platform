"""
RUN 3 — LinkedIn España + Colombia: roles creativos amplios (mayor volumen, menos descripciones)
Estrategia: LinkedIn da volumen de títulos y empresas que contratan aunque no da descripción detallada.
Foco en empresas editoriales, plataformas de contenido, agencias creativas con foco cultural.
"""
import sys
...
WRONG_ROLES = [
    ...
    "QA Engineer", "Tester", "Desarrollador", "Programador",
...
SEARCHES = [
    # LinkedIn España — roles creativos/editoriales
    {"term": "diseño editorial",                    "country": "Spain"},
    {"term": "content manager editorial",           "country": "Spain"},
    {"term": "diseñadora gráfica libros",           "country": "Spain"},
    {"term": "marketing editorial publicaciones",   "country": "Spain"},
    {"term": "responsable contenidos culturales",   "country": "Spain"},
    {"term": "creative strategist editorial",       "country": "Spain"},
    # LinkedIn Colombia
    {"term": "diseño editorial Colombia",           "country": "Colombia"},
    {"term": "marketing editorial Colombia",        "country": "Colombia"},
    # LinkedIn México
    {"term": "diseño editorial Mexico",             "country": "Mexico"},
    {"term": "content manager libros editorial",    "country": "Mexico"},
]
...
for s in SEARCHES:
    print(f"\nRUN3 | LinkedIn {s['country']} | '{s['term']}'")
    try:
        jobs = scrape_jobs(
            site_name      = ["linkedin"],
            search_term    = s["term"],
...
out = f"C:/Users/PREDATOR/Documents/MonaisLair/projects/personal/career-daihana/jobspy-results/run3-{ts}.csv"
