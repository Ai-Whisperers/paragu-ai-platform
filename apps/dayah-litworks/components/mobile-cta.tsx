export function MobileCta({ phone }: { phone: string }) {
  ...
  const href = `https://wa.me/${cleanPhone}?text=${encodeURIComponent("Hola! Quiero encargar mi portada")}`
  return (
    <div className="fixed bottom-0 left-0 right-0 z-40 border-t border-border bg-white p-3 shadow-lg md:hidden">
      <a
        ...
        className="flex items-center justify-center gap-2 rounded-lg bg-primary px-6 py-3 font-semibold text-primary-foreground transition-all hover:bg-primary/90 active:scale-[0.98]"
      >
