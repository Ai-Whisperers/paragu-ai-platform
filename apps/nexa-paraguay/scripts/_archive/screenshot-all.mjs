...
const PAGES = [
  ...
  { name: 'benelux', url: '/benelux' },
  { name: 'fundador', url: '/fundador' },
  { name: 'glosario', url: '/glosario' },
  { name: 'asistente', url: '/asistente' },
  { name: 'calidad-de-vida', url: '/calidad-de-vida' },
  { name: 'casos-de-exito', url: '/casos-de-exito' },
  { name: 'comparacion', url: '/comparacion' },
  { name: 'empresa', url: '/empresa' },
  { name: 'inversor', url: '/inversor' },
...
async function capturePageDiagnostics(page, pageUrl, iterationDir, pageName) {
  const base = path.join(iterationDir, pageName)
  const maxAttempts = 3
  let lastError
