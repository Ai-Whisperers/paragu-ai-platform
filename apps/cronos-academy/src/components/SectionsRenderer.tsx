          ...
          {items.slice(0, 8).map((img: any, i: number) => (
            <div key={i} style={{ aspectRatio: '1', background: '#e5e7eb', borderRadius: '0.75rem', overflow: 'hidden', position: 'relative' }}>
              <img src={img.url || img.src || `https://picsum.photos/400/400?random=${i}`}
                alt={img.caption || img.alt || 'Instalaciones del gym'}
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '3rem', marginBottom: '3rem' }}>
          ...
          <div>
            ...
            <ul style={{ listStyle: 'none', padding: 0, lineHeight: 2 }}>
              <li><a href="#programas" style={{ color: 'rgba(255,255,255,0.7)', textDecoration: 'none' }}>Programas</a></li>
              <li><a href="#galeria" style={{ color: 'rgba(255,255,255,0.7)', textDecoration: 'none' }}>Galería</a></li>
              <li><a href="#testimonios" style={{ color: 'rgba(255,255,255,0.7)', textDecoration: 'none' }}>Testimonios</a></li>
              <li><a href="#contacto" style={{ color: 'rgba(255,255,255,0.7)', textDecoration: 'none' }}>Contacto</a></li>
            </ul>
          </div>
          <div>
