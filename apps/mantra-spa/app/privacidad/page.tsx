...
export const metadata = { title: "Política de Privacidad — Mantra Spa" }
      ...
      <main className="bg-background py-20">
        <div className="max-w-3xl mx-auto px-4">
          ...
          <div className="prose prose-sm max-w-none text-foreground-light space-y-4">
            <p>En Mantra Spa nos tomamos muy en serio la privacidad de nuestros usuarios. Esta política describe cómo recopilamos, usamos y protegemos tu información personal.</p>
