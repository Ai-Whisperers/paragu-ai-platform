export function CtaBanner({
  ...
  return (
    <section className="relative overflow-hidden py-20 bg-[#0f1a2e]">
      ...
      <div className="relative z-10 mx-auto max-w-3xl px-4 text-center">
        ...
        <a
          ...
          className="inline-flex items-center gap-2 rounded-lg bg-[#c9a96e] px-8 py-4 text-base font-bold text-white shadow-lg transition-all hover:bg-[#b8944e] hover:scale-105"
        >
