...
version: alpha
name: Mantra Spa
description: Auto-generated DESIGN.md for mantra-spa. Refine colors, typography, components sections as design matures.
colors:
  accent: "#0F1A2E"
  primary-light: "#1A3050"
  fg-muted: "#C9A96E"
  secondary-dark: "#B8944E"
  bg: "#F8F7F4"
  surface: "#FFFFFF"
...
`mantra-spa` — auto-generated design spec from `apps/mantra-spa/globals.css`.
...
- ✅ **AAA** 12.86:1 — `fg` (#2D2D2D) on `bg` (#F8F7F4) — body text
...
- ✅ **AAA** 16.23:1 — `accent` (#0F1A2E) on `bg` (#F8F7F4) — link text
