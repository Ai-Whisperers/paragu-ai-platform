...
import MetatronFeature from "@/components/metatron-feature";
  ...
  return (
    <>
      ...
      <PromoBanner
        ...
        title={h.promo.title}
        subtitle={h.promo.subtitle}
        ctaText={h.promo.ctaText}
        ctaHref={h.promo.ctaHref}
      />
      ...
      {/* Metatron Feature — highlight section */}
      <MetatronFeature
        title={h.metatron.title}
        description={h.metatron.description}
        abv={h.metatron.abv}
        ibu={h.metatron.ibu}
        content={h.metatron.content}
        ctaText={h.metatron.ctaText}
        ctaHref={h.metatron.ctaHref}
      />
      ...
      <HomeGallery
        ...
        subtitle={h.gallery.subtitle}
        ctaText="Ver galería completa"
        ctaHref="/galeria"
        images={(c.gallery?.images || []).slice(0, 6)}
      />

      {/* Packs / Pricing Preview */}
      <HomePricing
        title={h.pricing.title}
        subtitle={h.pricing.subtitle}
        ctaText="Ver todos los packs"
        ctaHref="/tienda"
        packs={c.tienda?.packs?.slice(0, 5).map((p: any) => ({
          id: p.id,
          name: p.name,
          price: p.price,
