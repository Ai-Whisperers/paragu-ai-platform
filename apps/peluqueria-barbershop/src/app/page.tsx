...
export const metadata: Metadata = {
  ...
  keywords: ['PY', 'Paraguay', 'Asunción', 'peluqueria-barbershop'],
  robots: 'index, follow',
  alternates: {
    canonical: 'https://peluqueria-barbershop.paragu-ai.com',
  },
  openGraph: {
    title: 'Peluquería Barbershop | Servicios profesionales en Asunción',
    description: 'Peluquería Barbershop — Local business in Asunción, Paraguay.',
    url: 'https://peluqueria-barbershop.paragu-ai.com',
    siteName: 'ParaguAI',
    locale: 'es_PY',
    type: 'website',
    images: [{
      url: 'https://peluqueria-barbershop.paragu-ai.com/og/og-image.png',
      width: 1200,
      height: 630,
  ...
  twitter: {
    ...
    title: 'Peluquería Barbershop | Servicios profesionales en Asunción',
    description: 'Peluquería Barbershop — Local business in Asunción, Paraguay.',
    images: ['https://peluqueria-barbershop.paragu-ai.com/og/og-image.png'],
  },
};
