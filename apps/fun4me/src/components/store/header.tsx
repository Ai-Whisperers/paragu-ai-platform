...
import { DarkModeToggle } from "@/components/vendor/dark-mode-toggle"
...
export function Header() {
  ...
  return (
    <header className={`sticky top-0 z-40 border-b border-border bg-background/80 backdrop-blur-xl transition-all ${scrolled ? "shadow-sm" : ""}`}>
      {/* Search bar */}
      {searchOpen && (
