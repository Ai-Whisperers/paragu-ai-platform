...
const jsonLd = {
  ...
  "sameAs": ["https://instagram.com/ndebarba.py"],
  aggregateRating: {
...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="es">
      <head>
        <meta property="og:image" content="https://nde-barba.paragu-ai.com/og/og-image.png" />
        <meta property="og:image:width" content="1200" />
        <meta property="og:image:height" content="630" />
        <meta property="og:url" content="https://nde-barba.paragu-ai.com" />
        <meta property="og:site_name" content="Nde Barba" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:image" content="https://nde-barba.paragu-ai.com/og/og-image.png" />
