...
export default function ErrorPage({ error: _error, reset }: { error: Error & { digest?: string }; reset: () => void }) {
  void _error
  const message = "Hola! Tuve un problema cargando la página. ¿Podés ayudarme?"
    ...
    <>
      ...
      <main className="min-h-[60vh] flex items-center justify-center bg-background">
        <div className="text-center px-4 max-w-lg mx-auto">
          <h1 className="font-heading text-4xl font-bold text-primary mb-2">Algo salió mal</h1>
          <p className="text-foreground-light mb-8">Ocurrió un error inesperado. Por favor intentá de nuevo o escribinos por WhatsApp.</p>
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            ...
            <a href={whatsappUrl} target="_blank" rel="noopener noreferrer"
              className="px-6 py-3 bg-green-500 text-white rounded-lg font-semibold hover:bg-green-600 transition-all inline-flex items-center justify-center gap-2">
