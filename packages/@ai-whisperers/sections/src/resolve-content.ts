 ...
 */
export function resolveContent(content: Record<string, any> | null | undefined, key: string): any {
 ...
 */
export function resolveImage(images: Record<string, any> | null | undefined, ref: string): string {
