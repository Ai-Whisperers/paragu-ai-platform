"use client";
// Auth context provided by consumer app
// import { useAuth } from "../../lib/auth-context"
import { useEffect, useState } from "react";
const KEY = "viajero_cart_merged";
export function CartMerger() {
    const user = { id: 'anonymous' }; // useAuth() provided by consumer app
    ...
    useEffect(() => {
        ...
        guestCart.forEach((guestItem) => {
            if (!mergedCart.find((i) => i.name === guestItem.name)) {
...
//# sourceMappingURL=cart-merger.js.map