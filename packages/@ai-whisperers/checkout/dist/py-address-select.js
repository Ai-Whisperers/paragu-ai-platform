...
export function ParaguayAddressSelect({ onCityChange, onDeptChange }) {
    const handleDept = (e) => {
        onDeptChange?.(e.target.value);
        onCityChange("");
    };
    return (_jsxs("div", { className: "grid grid-cols-2 gap-3", children: [_jsxs("select", { onChange: handleDept, className: "rounded-lg border border-input bg-background px-3 py-2.5 text-sm outline-none focus:border-ring", children: [_jsx("option", { value: "", children: "Departamento" }), departments.map(d => _jsx("option", { children: d.name }, d.name))] }), _jsx("select", { onChange: e => onCityChange(e.target.value), className: "rounded-lg border border-input bg-background px-3 py-2.5 text-sm outline-none focus:border-ring", children: _jsx("option", { value: "", children: "Ciudad" }) })] }));
}
//# sourceMappingURL=py-address-select.js.map