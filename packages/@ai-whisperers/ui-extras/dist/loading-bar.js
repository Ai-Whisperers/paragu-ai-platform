...
export function PageLoadingBar() {
    ...
    return (_jsx("div", { className: "fixed top-0 left-0 right-0 z-[60] h-0.5 bg-muted", children: _jsx("div", { className: "h-full bg-primary transition-all duration-300 " + (loading ? "w-3/4" : "w-0") }) }));
}
