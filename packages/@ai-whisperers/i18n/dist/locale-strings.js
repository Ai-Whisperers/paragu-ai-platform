...
export const FEEDBACK_SECTION = {
    ...
    de: {
        ...
        messagePlaceholder: "Schreiben Sie Ihren Kommentar oder Ihre Frage...",
        button: "Senden",
 ...
 */
export function getLocaleStrings(set, locale) {
    return set[locale] || set["es"] || {};
}
/**
 * Get a single key from a locale string set with fallback.
 */
export function t(set, locale, key, fallback) {
